...
const Signup = () => {
  ...
  const [countrySelected, setCountrySelected] = useState("Maroc");
  ...
  return (
    <div className="signup">
      <h1 className="signup-title-signup">
        {language === "anglais"
          ? "Welcome on go.ibendouma, Register to get more offers !"
          : " Bienvenue sur go.ibendouma, inscrivez vous pour avoir plus d'offres !"}
      </h1>
            ...
            <div className="form-encapsulate-two">
              <div>
                ...
                >
                  ...
                  {allCountry.slice(1, allCountry.length).map((country) => (
